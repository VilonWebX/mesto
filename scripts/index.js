...
const userNameInput = document.querySelector('#name__input');
const userJobInput = document.querySelector('#job__input');
const userNamedInput = document.querySelector('#named__input');
const userLinkInput = document.querySelector('#link__input');
...
function handleSubmit(evt) {
  ...
  console.log({
    ...
    usernamed: userNamedInput.value, 
    userLink: userLinkInput.value
  })
}
